...
export function generateBadgeSVG(config: BadgeConfig): string {
  ...
  <!-- First Contribution Playground branding -->
  <text x="330" y="110" font-family="system-ui, sans-serif" font-size="8" fill="#484f58" text-anchor="end">First PR Playground</text>
</svg>`;
}
